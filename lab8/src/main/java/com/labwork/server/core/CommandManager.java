...
public class CommandManager {
    ...
    private static int executedCommandsCounter = 0;
    ...
    public CommandManager(DatabaseManager dbManager, AuthManager authManager) {
        ...
        commands.put("server_info", new ServerInfo());
    ...
    public static int getExecutedCommandsNumber(){
        return executedCommandsCounter;
    }
}
