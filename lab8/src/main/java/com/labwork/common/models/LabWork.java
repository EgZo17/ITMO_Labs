...
import com.labwork.server.core.LocalDateAdapter;
...
public class LabWork implements Serializable, Comparable<LabWork> {
    ...
    public int compareTo(LabWork other) {
        // Сравниваем по minimalPoint (для add_if_min)
        if (this.minimalPoint == null && other.minimalPoint == null) return 0;
        if (this.minimalPoint == null) return 1;
        if (other.minimalPoint == null) return -1;
        return Float.compare(this.minimalPoint, other.minimalPoint);
    }
}
